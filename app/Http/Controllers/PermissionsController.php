...
class PermissionsController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->back()->withSuccess("Permission successfully added");
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $role->update($data);
        return redirect()->route('admin.permissions.index')->withSuccess("Permission successfully updated");
    }
